...
import type { Model3D } from '@/features/shared-3d/types/model3d.types';

// shared-3d에서 공유 타입 re-export (순환 의존성 방지)
export type { Model3D, ModelType, Vector3Tuple } from '@/features/shared-3d/types/model3d.types';
