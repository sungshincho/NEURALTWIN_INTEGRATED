...
/**
 * Website channel handler — retail-chatbot pipeline
 * Extracted from retail-chatbot/index.ts for unified-chatbot integration
 */
export async function handleWebsiteRequest(request: Request): Promise<Response> {
