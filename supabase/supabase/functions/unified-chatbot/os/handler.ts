...
/**
 * OS channel handler — neuraltwin-assistant pipeline
 * Extracted from neuraltwin-assistant/index.ts for unified-chatbot integration
 */
export async function handleOSRequest(req: Request): Promise<Response> {
  // CORS preflight
